...
/*
This file contains the script location path in case of CDN. Example, ServiceWorker.js uses this info to refer the script paths
The value will be modified by the build file
clientURL will be modified by this file AddingSRIToCDN.js
*/
